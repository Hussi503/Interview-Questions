...
### ✅ Answer
    ...
    For subnet-level blocking, I would use a Network ACL (NACL) because it supports explicit Deny rules. I can add a rule to     deny the specific CIDR range,and the traffic will be blocked before reaching any resource in that subnet.
